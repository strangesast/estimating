...
import { ProjectObject, Commit, ObjectRecord, IndexRecord, RefRecord, ProjectComponent, ProjectComponentInstance, ProjectFolder } from './models';
import { modes } from './modes';
import * as sha1 from 'js-sha1';
import { encoders, decoders, frame, deframe } from './git-util';
...
export class GitStore extends Dexie {
  HEAD: string;
  ...
  // updates records in the working tree to match the version in the index or specified tree. if no paths are given, also updates HEAD.  git checkout <branch>
